# SCMM Online Health Check (Brian Dalton)
...
The Calendly QR code on the PDF routes to **Brian Dalton**
(Brian.Dalton@RingRingMarketing.com).

Target deploy URL: `scmm-healthcheck-brian.streamlit.app`
...
3. Settings:
   - **Repository:** `weltonhong/scmm-healthcheck-brian`
   - **Branch:** `main`
